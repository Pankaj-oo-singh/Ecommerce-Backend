package com.BackendEcommerce.mapper;


import com.BackendEcommerce.Entities.*;
import com.BackendEcommerce.dto.ProductDto;
import com.BackendEcommerce.dto.ProductResourceDto;
import com.BackendEcommerce.dto.ProductVariantDto;
import com.BackendEcommerce.services.CategoryService;
...
public class ProductMapper {
    ...
    private String getProductThumbnail(List<Resources> resources) {
        return resources.stream()
                ...
                .findFirst()
                .map(Resources::getUrl) // Map to URL if found
                .orElse(null); // Safely return null if no primary resource is found
    }
